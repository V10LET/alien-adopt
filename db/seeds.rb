...
uro = Planet.create(name: "Turo", climate: "Chilly", gravity: 47, diet: "Ring Sprinkles")
...
timelord = Alien.create(toy: time_machine, name: "Time Lord", bio: "travels time and space for friendship, adventure, and ruckus", owner: violet, planet: Turo,  therapy: true)
