...
stitch = Alien.create(name: "Stitch", owner: jordan, planet: errkt,  therapy: true)
roger = Alien.create(name: "Roger", owner: jordan, planet: errkt,  therapy: false)
eetee = Alien.create(name: "E.T.", owner: morgan, planet: errkt,  therapy: true)
zoidburg = Alien.create(name: "Zoidburg", owner: zoe , planet: zirgon9,  therapy: false)
glip_glops = Alien.create(name: "Glip Glops", owner: micheal, planet: texacar,  therapy: false)
timelord = Alien.create(name: "Time Lord", owner: violet, planet: saturn,  therapy: true)
moon_creature = Alien.create(name: "Moon Creature", owner: violet, planet: mars,  therapy: true)
tree_guy = Alien.create(name: "Tree Guy", owner: christie, planet: mars,  therapy: true)
